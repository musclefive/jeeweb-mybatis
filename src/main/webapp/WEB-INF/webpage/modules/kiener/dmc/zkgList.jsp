					...
					<div class="col-xs-12">
						...
						<div class="row">
							...
							<ul class="nav nav-tabs" id="myTab">
								...
								<li >
									<a data-toggle="tab" href="#divZKGList">
										<i class="blue ace-icon fa fa-tachometer bigger-110"></i>
										<span id="spanCount">缸体发交数量 </span>
									</a>
								</li>
							...
							<div class="tab-content">
								...
								<div id="divZKGDailyList" class="tab-pane in active">
									...
									<div class="row">
										<table id="tableZKGDailyList" class="table table-striped table-bordered table-hover">
								...
								<div id="divZKGList" class="tab-pane fade">
									...
									<div class="row">
										...
										<div class="modal fade" id="ZKGDetialModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="col-sm-12 table-bordered border">
											<div class="row">
												<div class="col-sm-4">
													...
													06K103011CP01556742RRRRR"></textarea>
														<br/>
														<!-- #section:plugins/date-time.datetimepicker -->
												...
												<div class="col-sm-8">
													...
													<table id="tableZKGQueryList" class="table table-striped table-bordered table-hover">
...
//						$(row).css('backgroundColor','#FFFF00');
			...
			"fnDrawCallback" : function(object){
				$("#spanCount").html("缸体发交数量(" + object.aoData.length + ")");
...
//						}
...

				{
					...
					"render": function(data, type, row) {
						...
						return "<a href=javascript:submitData('" + data +"','"+queryType+"'); >" + data.substring(11,19) + "</a>";
					}
				},
				{
					"data": "dmc",
...
//			console.info("inti table :" + dataResult.length);
		tableQueryList = $('#tableZKGQueryList').dataTable( {
