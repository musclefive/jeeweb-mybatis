								...
								<div class="row">
									<div class="infobox infobox-grey infobox-small infobox-dark">
										<div class="infobox-data">
											<div class="infobox-content">曲轴上线</div>
									...
									<div class="infobox infobox-blue infobox-small infobox-dark">
										<div class="infobox-data">
											<div class="infobox-content">蓝色 B</div>
											<div class="infobox-content" id="divBlueNumber">0</div>
										</div>
									</div>
									<div class="infobox infobox-light-brown infobox-small infobox-dark">
										<div class="infobox-data">
											<div class="infobox-content">白色 W</div>
											<div class="infobox-content" id="divWhiteNumber">0</div>
										</div>
									</div>
								</div>
							</div>
...
* */
		$("#btnQuery").click(function() {
			...
			initTable(startDate,endDate,"70",currentType);
		});
...
//				console.info("init complete: " + strTotalColoredWapian);
				...
				$("#divBlueNumber").html (parseInt(strTotalColoredWapian.split("B").length) - 1);
				$("#divWhiteNumber").html (parseInt(strTotalColoredWapian.split("W").length) - 1);
